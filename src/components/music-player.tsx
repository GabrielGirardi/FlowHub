        ...
        <div className="space-y-4">
          <div className="text-center p-4 bg-gradient-to-r from-pink-500/20 to-purple-500/20 rounded-lg border border-pink-500/30">
            <div className="text-lg font-semibold text-pink-400 mb-1">
              {mimic.lofiStations[currentStation].name}
            </div>
            <div className="text-sm text-gray-400">
              {mimic.lofiStations[currentStation].description}
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            {mimic.lofiStations.map((station, index) => (
              <button
                key={index}
          ...
          {showPlayer && (
            <div className="hidden">
              <iframe
                ref={iframeRef}
                src={mimic.lofiStations[currentStation].url}
