...
const YoutubePlayer = () => {
  ...
  const handleSearch = () => {
    ...
    const results = mimic.pages.youtubePlayer.sampleVideos.filter(
      (video) =>
  ...
  const addToWatchHistory = (id: string, title?: string) => {
    const videoTitle =
      title ||
      mimic.pages.youtubePlayer.sampleVideos.find((v) => v.id === id)?.title ||
      savedVideos.find((v) => v.id === id)?.title ||
      "Video desconhecido";
      ...
      <div className="container mx-auto max-w-7xl px-4 py-8">
        ...
        >
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
            Descubra e reproduza vídeos do YouTube com uma experiência moderna e
            intuitiva
          </p>
        </motion.div>
              ...
              <div className="aspect-video flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-muted-foreground text-lg">
                    Nenhum vídeo carregado. Cole um link do YouTube ou pesquise
                    vídeos acima.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-center justify-between w-full">
                <div className="flex items-center space-x-3">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-muted-foreground text-sm">
                      {savedVideos.length} vídeos salvos
                    </p>
                  </div>
                </div>
                {isFavoritesOpen ? (
              ...
              <div className="flex items-center justify-between w-full">
                <div className="flex items-center space-x-3">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-muted-foreground text-sm">
                      {watchHistory.length} vídeos assistidos
                    </p>
                  </div>
                </div>
                {isHistoryOpen ? (
                  ...
                  {searchResults.length === 0 ? (
                    <div className="text-center py-12">
                      ...
                      <p className="text-muted-foreground">
                        Nenhum resultado encontrado. Tente outros termos de
                        pesquisa.
                      </p>
                    </div>
                  ) : (
                        ...
                        <AlertDialogContent className="bg-card border-border">
                          <AlertDialogHeader>
                            ...
                            <AlertDialogDescription className="text-muted-foreground">
                              Tem certeza que deseja remover todos os vídeos
                        ...
                        <AlertDialogContent className="bg-card border-border">
                          <AlertDialogHeader>
                            ...
                            <AlertDialogDescription className="text-muted-foreground">
                              ...
                              reprodução? Esta ação não pode ser desfeita.
                            </AlertDialogDescription>
                          </AlertDialogHeader>
                          <AlertDialogFooter>
                            <AlertDialogCancel className="bg-secondary text-secondary-foreground border-border">
