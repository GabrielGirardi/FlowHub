...
const QuickSearch = () => {
  ...
  const addItem = () => {
    ...
    toast({
      ...
      description: `${
        item.type === "note" ? "Nota" : item.type === "task" ? "Tarefa" : "Link"
      } criado com sucesso.`,
    });
  };
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        setNewItem((prev) => ({
                          ...prev,
                          type: e.target.value as SearchItem["type"],
                        }))
                      }
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        setNewItem((prev) => ({
                          ...prev,
                          priority: e.target.value as SearchItem["priority"],
                        }))
                      }
                      className="px-3 py-2 border border-border rounded-md bg-background"
                    >
            ...
            >
              ...
              <p className="text-muted-foreground">
                {searchTerm
                  ...
                  : "Adicione sua primeira nota, tarefa ou link para começar"}
              </p>
            </motion.div>
          )}
        </motion.div>
