...
const CurrencyConverter = () => {
  ...
  const fetchExchangeRates = async (baseCurrency: string) => {
    try {
      ...
      const fallbackRates =
        mimic.pages.currencyConverter.sampleRates[baseCurrency] || {};
    ...
    try {
      ...
      if (!exchangeRate) {
        toast({
          ...
          description:
            "Não foi possível encontrar a taxa de câmbio para esta conversão.",
          variant: "destructive",
        });
        setLoading(false);
        return;
  ...
  const setFavoriteConversion = (from: string, to: string) => {
        ...
        <Card>
          <CardContent className="p-6 text-center">
            <div className="text-2xl font-bold text-green-600 mb-2">
              {mimic.pages.currencyConverter.currencies.length}
            </div>
                  ...
                  <Select value={fromCurrency} onValueChange={setFromCurrency}>
                    ...
                    <SelectContent>
                      <SelectGroup>
                        ...
                        {mimic.pages.currencyConverter.currencies.map(
                          (currency) => (
                            <SelectItem
                              key={currency.code}
                              value={currency.code}
            ...
            {favoriteConversions.map((fav) => {
              ...
              return (
                <Card
                  ...
                  onClick={() => setFavoriteConversion(from, to)}
                >
