    ...
    <div className="mx-auto space-y-8">
      <div className="text-center space-y-4">
        ...
        <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
          Crie sua atmosfera perfeita com nosso mixer de sons ambientais e
          desfrute de transmissões lo-fi ao vivo
        </p>
      </div>
      <LiveStreamPlayer />
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <ul className="text-sm text-amber-700 dark:text-amber-300 space-y-1">
                ...
                <li>
                  • Experimente diferentes estações de rádio para variar o
                  estilo
                </li>
                <li>
                  • Ajuste os volumes individualmente para encontrar o
                  equilíbrio perfeito
                </li>
              </ul>
            </div>
